...
if __name__ == "__main__":
    ...
    #####DENSE#####
    #slice_include = [['synth_size', '34'], ['synth_size', '35'], ['synth_size', '36'], ['synth_size' ,'37'], ['synth_size', '38'], ['synth_size', '39'], ['synth_size', '40']]
    slice_include = [['synth_size', '32'], ['synth_size', '33']]
    #slice_include = [['synth_size', '34'], ['synth_size', '35']]
    bool_include = [['decomposition', 0], ['ordering', 1], ['ordering', 2]]
    bool_include2 = [['decomposition', 0], ['ordering', 0]]
    
    
    exclude = [['algo_name', 'gpu_perman_xlocal'], ['algo_name', 'gpu_perman_xlocal_sparse'], ['algo_name', 'gpu_perman_xshared_coalescing_mshared_skipper']]

    
    #include = []
    #exclude = []
    
    #one_chart(df, [['ordering', 1]], [['synth_density', '0.70'], ['synth_density', '0.80']])
    #two_charts(df, bool_include, slice_include, exclude)
    #two_charts(df, bool_include2, slice_include, exclude)
    #one_chart(df, bool_include, slice_include, exclude)
    #one_chart(df, bool_include2, slice_include, exclude)

    dense_include = [['decomposition', 0], ['ordering', 0], ['sparse', 0]]
    slice_include_smallest = [['synth_size', '32'], ['synth_size', '33']]
    slice_include_smaller = [['synth_size', '34'], ['synth_size', '35'], ['synth_size', '36'], ['synth_size' ,'37']]
    slice_include_bigger = [['synth_size', '38'], ['synth_size', '39'], ['synth_size' ,'40']]
    ...
    #general_graph(df, 'synth_size', 'time', 'algo_name', 'synth_density', densities,
    #sparse_include, slice_include_bigger, exclude, 'Single GPU - Sparse - Bigger')

    general_graph(df, 'synth_size', 'time', 'algo_name', 'synth_density', densities,
    sparse_include2, slice_include_smaller, exclude, 'Single GPU - Sparse - Smaller - Ordering')

    #general_graph(df, 'synth_size', 'time', 'algo_name', 'synth_density', densities,
    #sparse_include2, slice_include_bigger, exclude, 'Single GPU - Sparse - Bigger')


    all_include = [['decomposition', 0], ['ordering', 1]]
